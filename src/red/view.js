...
module.exports = function (RED) {
    ...
    function redraw() {
        ...
        if (mouse_mode != RED.state.JOINING) {
            ...
            if (activeSubflow) {
                var subflowOutputs = vis.selectAll(".subflowoutput").data(activeSubflow.out,function(d){ return d.id;});
                ...
                var subflowInputs = vis.selectAll(".subflowinput").data(activeSubflow.in,function(d){ return d.id;});
            ...
            var nodeEnter = node.enter().insert("svg:g")
                ...
                .classed("node_subflow",function() { return activeSubflow != null; })
                    ...
                    if (mouse_mode != RED.state.MOVING_ACTIVE) {
                        ...
                        if (d._ports) {
                            ...
                            d._ports.each(function(d,i) {
                                ...
                                port.attr("transform", function() { return "translate("+x+","+((y+13*i)-5)+")";});
                            });
                        }
                        thisNode.selectAll("text.node_label").text(function(d){
                            var l = "";
                            if (d._def.label) {
                                l = d._def.label;
                                try {
                                    ...
                                    console.error("Definition error: "+d.type+".label",err);
                                    l = d.type;
                                }
                            }
                            return l;
                            ...
                            .attr("class",function(d){
                                ...
                                if (d._def.labelStyle) {
                                    ...
                                    try {
                                        ...
                                        console.error("Definition error: "+d.type+".labelStyle",err);
                                        s = "";
                                    }
                                    s = " "+s;
                                }
                        ...
                        thisNode.selectAll(".port_input").each(function() {
                            var port = d3.select(this);
                        ...
                        thisNode.selectAll("text.node_badge_label").text(function(d) {
                            if (d._def.badge) {
                                if (typeof d._def.badge == "function") {
                                    try {
                                        return d._def.badge.call(d);
                                    } catch(err) {
                                        console.error("Definition error: "+d.type+".badge",err);
                                        return "";
                                    }
                                } else {
                                    return d._def.badge;
