...
(function() {
    ...
    const isElement = obj => true;//obj instanceof HTMLElement || obj instanceof SVGElement;
    ...
    out$.saveSvgAsPng = (el, name, options) => {
      requireDomNode(el);
      out$.svgAsPngUri(el, options || {}, uri => out$.download(name, uri)).catch(err => { console.log(err) });
    };
  })();